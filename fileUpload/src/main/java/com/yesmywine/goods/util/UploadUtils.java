...
public class UploadUtils {
	...
	public static String generateFilename(String path, String ext, String last) {
		return path + MONTH_FORMAT.format(new Date())
				+ RandomStringUtils.random(4, Num62.N36_CHARS)+ last + "." + ext;
	}
	...
	public static String customFileName(String path, String ext,String fileName) {
		return path + "/"+YEAR_MONTH_FORMAT.format(new Date())+"/"
				+ fileName + "" + ext;
	}
