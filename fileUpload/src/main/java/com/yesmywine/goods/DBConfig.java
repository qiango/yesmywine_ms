...
public class DBConfig {
    ...
    private String url = Database.FILE_URL;
    ...
    @Value("${fileFormal.url}")
    private String fileFormalUrl;
...
//    @Qualifier("userDataSource")
    public DataSource dataSource() {
        ...
        FileUploadUrl.FILETEMPURL=fileTempUrl;
        FileUploadUrl.FILEFORMALURL=fileFormalUrl;
        return dataSource;
    }
