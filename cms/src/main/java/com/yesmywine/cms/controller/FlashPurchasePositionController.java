 ...
 */
@RestController
@RequestMapping("/cms/flashPurchasePosition")
public class FlashPurchasePositionController {
    @Autowired
    ...
    public String create(Integer positionId) {   //新增
        try {
            ...
            String insert = this.flashPurchasePositionService.insert(positionId);
    ...
    public String update(Integer id, Integer positionId) {   //修改
        try {
            ...
            ValueUtil.verify(positionId,"positionId");
            String update = this.flashPurchasePositionService.update(id, positionId);
    ...
    public String deleteFirst(Integer id) {
        try {
            ValueUtil.verify(id,"id");
            String delete = this.flashPurchasePositionService.delete(id);
