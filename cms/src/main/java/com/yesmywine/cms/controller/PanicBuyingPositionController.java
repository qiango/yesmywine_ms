 ...
 */
@RestController
@RequestMapping("/cms/panicBuyingPosition")
public class PanicBuyingPositionController {
    ...
    public String create(Integer positionId) {   //新增
        try {
            ...
            String insert = this.panicBuyingPositionService.insert(positionId);
    ...
    public String update(Integer id, Integer positionId) {   //修改
        try {
            ...
            ValueUtil.verify(positionId,"positionId");
            String update = this.panicBuyingPositionService.update(id, positionId);
    ...
    public String deleteFirst(Integer id) {
        try {
            ValueUtil.verify(id,"id");
            String delete = this.panicBuyingPositionService.delete(id);
