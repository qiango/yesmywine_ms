...
//		}
        if (!adminLogin) {
            ...
            if (userInfo == null || userInfo.equals("")) {
                ...
                return onLoginFailure(token, failureUrl, adminLogin, ae, request, response);
            }
        }
...
//					uptoken.setPassword(strChar);
     ...
     * 登录成功
     */
    public boolean onLoginSuccess(AuthenticationToken token, boolean adminLogin, Subject subject,
...
//		unifiedUserMng.updateLoginSuccess(user.getId(), ip);
    ...
    public boolean loadIndexLogin(AuthenticationToken token, boolean adminLogin, Subject subject,
                                  ServletRequest request, ServletResponse response, String username) throws Exception {
