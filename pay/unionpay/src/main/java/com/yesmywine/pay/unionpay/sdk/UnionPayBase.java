...
import com.yesmywine.pay.unionpay.util.PropertiesUtil;
...
public class UnionPayBase {
    ...
    //后台服务对应的写法参照 FrontRcvResponse.java 前台
//    public static String frontUrl = "http://139.219.226.16:8200/backUrl/unionpayFrontUrl.do";
//    public static String frontUrl = "http://127.0.0.1:8080/backUrl/unionpayFrontUrl.do";
    public static String frontUrl = PropertiesUtil.getString("frontUrl", "unionpay.properties");

    //后台服务对应的写法参照 BackRcvResponse.java  后台
//    public static String backUrl = "http://139.219.226.16:8181/backUrl/unionpayBackUrl.do";//受理方和发卡方自选填写的域[O]--后台通知地址
//    public static String backUrl = "http://127.0.0.1.16:8080/backUrl/unionpayBackUrl.do";//受理方和发卡方自选填写的域[O]--后台通知地址
    public static String backUrl = PropertiesUtil.getString("backUrl", "unionpay.properties");//受理方和发卡方自选填写的域[O]--后台通知地址
