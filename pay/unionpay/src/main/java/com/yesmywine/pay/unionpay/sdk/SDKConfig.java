...
public class SDKConfig {
    ...
    public void loadPropertiesFromSrc() {
        ...
        try {
            // Properties pro = null;
            System.out.println(SDKConfig.class.getClassLoader());
            System.out.println(SDKConfig.class.getClassLoader().getResource(""));
//            System.out.println(SDKConfig.class.getClassLoader().getResource("").getPath());
