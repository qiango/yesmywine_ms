...
import com.yesmywine.pay.unionpay.sdk.HttpClient;
import com.yesmywine.pay.unionpay.sdk.SDKConstants;
import com.yesmywine.pay.unionpay.sdk.SDKUtil;
 ...
 */
public class DemoBase extends PayFactory {
    //默认配置的是UTF-8
    ...
    public static Map<String, String> signData(Map<String, ?> contentData) {
         ...
         * 签名
         */
        SDKUtil.sign(submitFromData, encoding_UTF8);
    ...
    public static Map<String, String> submitUrl(
        ...
        try {
            int status = hc.send(submitFromData, encoding_UTF8);
            if (200 == status) {
