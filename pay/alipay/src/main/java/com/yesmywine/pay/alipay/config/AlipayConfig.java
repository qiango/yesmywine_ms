...
public class AlipayConfig {
    ...
    public static String partner = "2088521672775020";

    // 收款支付宝账号，一般情况下收款账号就是签约账号
    public static String seller_email = "yanghongyan@actionsky.com";
    // 商户的私钥ｍｄ５ｋｅｙ
    public static String key = "jqizxpf4uim4ue0xcyekuh5r4cdzfufi";
