package com.yesmywine.activity.tomcat;
...
public class ServiceProperties implements EmbeddedServletContainerCustomizer {
    ...
    public String[] getPathsArray(Collection paths) {
        String[] result = new String[paths.size()];
        int i = 0;
        for (Object path : paths) {
            result[i++] = getPath(path.toString());
        }
        return result;
    }
